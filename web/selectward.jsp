...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6">
            <h3 style="padding-bottom:1em">Select ward</h3>
            <div class="btn-group-vertical round-corner" style="width:100%; min-height: 19em">
                <a href="works.jsp?wardNumber=1" class="btn-link btn btn-default btn-lg btn-block"
                   style="border: 1px solid; border-color:#c1c1c1; border-top-left-radius: 0.6em; border-top-right-radius: 0.6em;">1</a>
                <%
                    for (int i = 2; i < 67; i++) {
                %>
                <a href="works.jsp?wardNumber=<%=i%>" class="btn-link btn btn-default btn-lg btn-block"
                   style="border: 1px solid; border-color:#c1c1c1; "><%=i%>
                </a>
                <%
                    }
                %>
                <a href="works.jsp?wardNumber=67" class="btn-link btn btn-default btn-lg btn-block round-corner-bottom"
                   style="border: 1px solid; border-color:#c1c1c1; border-bottom-left-radius: 0.6em; border-bottom-right-radius: 0.6em;">67</a>
            </div>
        </div>
        <div class="col-sm-3"></div>
    </div>
